...
// LAST BUILD (CMAKE): 2024-08-10 12:10:15
...
export namespace mut::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 630;
	
	constexpr uint32_t version = major * 10000 + minor * 1000 + patch;
	constexpr uint64_t random_seed = 0x9bd7fd2a4d27f030;
	
	constexpr char version_string[] = "v0.0.630";
	constexpr char build_time_string[] = "2024-08-10 12:10:15";
	constexpr char phrase[] = "skiing-dean-capital";
	constexpr char calver[] = "2024.32.630";
	constexpr char uuid[] = "6D55B06E-2718-4C8F-9967-E3DB16D71390";
